		...
		<?php include('includes/navbar.inc.php'); ?>
			...
			<div class="container p-2">
				...
				<?php
					...
					echo "<p class='lead'>There is currently $sum_chatbots chatbot(s) available to verify data for.</p>"
				?>
					...
					<table class="table">
						...
						<tbody>
							...
							<?php
								...
								echo "</td><td>$author</td><!--<td>$creator<br><font size='-1'>$create_time</font></td>--><td>$last_updated_by<br><font size='-1'>$last_updated</font></td><td><a href=\"verifying.php?id=$id\" class='btn btn-primary d-grid gap-2' role='button'><i class='fa fa-edit' aria-hidden='true'></i>
Verify</a>
								</td></tr>";
								}
